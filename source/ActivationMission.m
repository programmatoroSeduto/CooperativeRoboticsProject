...
if mission.mission_on
    switch mission.phase
        ...
        case mission.ph.trans_nav
            ...
            % uvms.Ap.ha = 1;
            uvms.Ap.ha = DecreasingBellShapedFunction( 0, mission.trans_nav.trans_time, 0, 1, mission.phase_time );;
            % uvms.Ap.align = 0;
            uvms.Ap.sh = IncreasingBellShapedFunction( 0, mission.trans_nav.trans_time, 0, 1, mission.phase_time );;
